'''
 When the link of the channel is entered it scraps the channel name, 
 description of the channel, the videos posted by the channel, 
 number of views and links to those videos.
'''
